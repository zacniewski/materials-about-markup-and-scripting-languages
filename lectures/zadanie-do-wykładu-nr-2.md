...
1. Zamieni wszystkie litery na wielkie (`upper`).
1. Zamieni słowo "Python" na "JS" (tylko w wyświetlaniu, nie zmieniając oryginału).
1. Rozdzieli tekst na listę słów (`split`).
