...
1. **Paradygmat obiektowy** (klasy, dziedziczenie).
1. **Języki znaczników** i prezentacji treści (Markdown, HTML, CSS).
1. **Wymianę danych** (JSON, XML, CSV, YAML).
1. **Tworzenie aplikacji webowych** (Flask, JavaScript).
1. **Profesjonalne narzędzia** (pip, venv, dobre praktyki).
