# Laboratorium 7: Praca z plikami i wyjątkami

## Cel zajęć
Bezpieczne otwieranie plików i obsługa błędów.

## Zadania
1. Napisz program, który prosi o podanie nazwy pliku i wypisuje jego treść. Obsłuż błąd `FileNotFoundError`.
2. Stwórz program, który pobiera od użytkownika 3 liczby i zapisuje je do pliku `liczby.txt`, każdą w nowej linii.
